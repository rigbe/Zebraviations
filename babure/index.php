...
<table width="100%" height="467" border="0">
  ...
  <tr>
    <td height="334" colspan="2" valign="top"><!-- InstanceBeginEditable name="Body" -->
      <table width="80%" height="314" border="0" align="center">
        <!--DWLayoutTable-->
        <tr>
          <td height="110" colspan="2" valign="top"><p>                                          <p></td>
        ...
        <tr>
          <td width="284" height="198" valign="top"><p> </p>
            <fieldset>
            <legend><em>What we do</em></legend>
            <p>Babure is a railway station system. You can use Babure to see train schedules; departures and arrivals. </p>
            <p>&nbsp;</p>
            </fieldset>
          <p></p>            <p></p></td>
        <td width="68">&nbsp;</td>
